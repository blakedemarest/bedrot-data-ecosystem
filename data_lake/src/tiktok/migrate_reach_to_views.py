...
DIRECTORIES_TO_MIGRATE = [
    PROJECT_ROOT / "4_curated" / "tiktok",
    PROJECT_ROOT / "3_staging",
    PROJECT_ROOT / "5_archive" / "tiktok",
...
class TikTokMigration:
    def __init__(self, dry_run: bool = True):
        ...
        self.backup_dir = PROJECT_ROOT / "5_archive" / "migration_backup" / datetime.now().strftime('%Y%m%d_%H%M%S')
        self.migration_log = []
